 ...
 */
public class DataFormatConvertersRewrite {
    ...
    static {
        ...
        t2C.put(DataTypes.TIME().bridgedTo(Time.class), TimeConverterRe.INSTANCE);
    ...
    /** Converter for time. */
    public static final class TimeConverterRe extends DataFormatConverter<Time, StringData> {

        private static final long serialVersionUID = -8061475784916442483L;

        public static final TimeConverterRe INSTANCE = new TimeConverterRe();

        private TimeConverterRe() {}


        @Override
        Time toInternalImpl(StringData value) {
            return null;
        }

        @Override
        StringData toExternalImpl(Time value) {
    ...
    public static final class ObjectArrayConverter<T> extends DataFormatConverter<ArrayData, T[]> {
        ...
        public ObjectArrayConverter(DataType elementType) {
            ...
            this.elementConverter = getConverterForDataType(elementType);
    ...
    public static final class MapConverter extends DataFormatConverter<MapData, Map> {
        ...
        public MapConverter(DataType keyTypeInfo, DataType valueTypeInfo) {
            ...
            this.keyConverter = getConverterForDataType(keyTypeInfo);
            this.valueConverter = getConverterForDataType(valueTypeInfo);
    ...
    public static final class RowConverter extends AbstractRowDataConverter<Row> {
        ...
        RowData toInternalImpl(Row value) {
            ...
            for (int i = 0; i < converters.length; i++) {
                if (converters[i] instanceof TimeConverterRe){
                    genericRow.setField(i, converters[i].toExternalImpl(value.getField(i)));
                }else {
